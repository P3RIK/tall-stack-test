@section('header', 'Table Form')

<div class="flex items-center justify-center p-4">
    <form wire:submit="createPost" class="flex flex-col gap-4 p-8 rounded bg-gray-600">
        ...
        <button type="submit" class="bg-red-600 hover:bg-blue-700 text-white rounded px-2 py-2 border border-gray-300">Submit</button>
